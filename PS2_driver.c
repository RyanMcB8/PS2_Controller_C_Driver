...
static uint8_t PS2CmdEnter_config[] = {0x01,0x43,0x00,0x01,0x00};
static uint8_t PS2CmdSet_mode[] = {0x01,0x44,0x00,0x01,0x03,0x00,0x00,0x00,0x00};
static uint8_t PS2CmdSet_bytes_large[] = {0x01,0x4F,0x00,0xFF,0xFF,0x03,0x00,0x00,0x00};
static uint8_t PS2CmdExit_config[] = {0x01,0x43,0x00,0x00,0x5A,0x5A,0x5A,0x5A,0x5A};
static uint8_t PS2CmdEnable_rumble[] = {0x01,0x4D,0x00,0x00,0x01};
static uint8_t PS2CmdType_read[] = {0x01,0x45,0x00,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A};
